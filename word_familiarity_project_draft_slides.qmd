...
adult_en = load_json(DATA_DIR / "regression_diagnostics_english.json")
adult_de = load_json(DATA_DIR / "regression_diagnostics_german.json")
kids_diag = load_json(DATA_DIR / "regression_diagnostics_german_kids.json")

adult_dir = DATA_DIR if adult_en else None
kids_dir = DATA_DIR if kids_diag else None
adult_result_stamp = "data"
kids_result_stamp = "data"
